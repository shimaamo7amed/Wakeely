...
@section('content')
<form action="{{ route(activeGuard().'.clients.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('post')
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
            ...
            <input type="hidden" class="phone_code" name="phone_code" id="phone_code" name="phone_code" value="{{ phone_code() }}">
            <input type="hidden" class="country_code" name="country_code" id="country_code" name="country_code" value="{{ country_code() }}">
            <input type="tel" class="form-control border-0 border-bottom rounded-0 phone" name="phone" id="phone" required value="">
        </div>
        <div class="col-md-6 col-sm-12">
...
@include('phone',['country_code'=>country_code()])
@endsection

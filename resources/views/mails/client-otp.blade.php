...
<body>
    <div class="header">
        <h1 style="color: #2c3e50; margin: 0;">Wakeely</h1>
    </div>
    ...
    <div class="content">
        ...
        <p>Thank you for registering with Wakeely. To ensure the security of your account, please use the following One-Time Password (OTP) to complete your verification:</p>
    ...
    <div class="footer">
        ...
        <p>&copy; {{ date('Y') }} Wakeely. All rights reserved.</p>
    </div>
</body>
</html>
